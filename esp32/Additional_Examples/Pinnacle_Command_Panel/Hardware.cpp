...
#define CS0_PIN   2      // Chip Select pin for Sensor 0
#define DR0_PIN   5       // Data Ready pin for Sensor 0
#define CS1_PIN   2       // Chip Select pin for Sensor 1
#define DR1_PIN   5       // Data Ready pin for Sensor 1
...
{
  digitalWrite(sensorList[sensorId].CS_Pin, LOW);
}

void HW_deAssertCS(uint8_t sensorId)
{
  digitalWrite(sensorList[sensorId].CS_Pin, HIGH);
}
